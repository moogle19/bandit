defmodule Bandit.HTTP2.Handler do
  ...
  @impl ThousandIsland.Handler
  def handle_shutdown(socket, %{connection: connection}) do
    Connection.shutdown_connection(Errors.no_error(), "Server shutdown", socket, connection)
  end

  @impl ThousandIsland.Handler
  def handle_timeout(socket, %{connection: connection}) do
    Connection.shutdown_connection(Errors.no_error(), "Client timeout", socket, connection)
  end
